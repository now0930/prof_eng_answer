...
현재 저장소에는 **Topic Sheet 82개와 Topic Pack 82개가 있으며, 동일한 `<topic_id>`로 모두 1:1 대응**합니다. Topic Sheet만 있고 Topic Pack이 없는 항목도 없고, Topic Pack만 있고 Topic Sheet가 없는 항목도 없습니다.
...
Topic Sheet와 Topic Pack의 개수는 특정 분야별 별도 집계보다 **전체 Topic inventory를 기준으로 관리**합니다. 현재 authoritative Topic inventory는 generated manifest 기준 82개입니다.
...
현재 저장소에는 **82개 Topic Pack**이 있으며 generated runtime bank는 다음 **6개**입니다.
